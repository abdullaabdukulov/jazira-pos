...
class CartWidget(QWidget):
    ...
    def init_ui(self):
        ...
        details_group.setStyleSheet("""
            QGroupBox { font-weight: bold; border: 1px solid #e5e7eb; border-radius: 10px;
            margin-top: 5px; background: #f9fafb; }
        ...
        self.checkout_btn.setStyleSheet("""
            QPushButton { background-color: #10b981; color: white; font-size: 24px;
    ...
    def refresh_table(self):
        ...
        for row_idx, (code, data) in enumerate(self.items.items()):
            ...
            qty_label.setStyleSheet("""
                ...
                background-color: #f3f4f6; border-radius: 6px; padding: 5px;
            """)
